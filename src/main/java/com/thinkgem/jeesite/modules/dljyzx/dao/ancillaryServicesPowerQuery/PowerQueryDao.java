...
@MyBatisDao
public interface PowerQueryDao extends CrudDao<JsAsTradeseq> {
    ...
    List<JsAsPowerQuery> queryData(JsAsPowerQuery jsAsPowerQuery);

    List<JsAsPowerQuery> queryDataNumber(JsAsPowerQuery jsAsPowerQuery);
}
