...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"不允许为空！",invalidMessage:null,rules:{email:{validator:function(_38b){
...
},message:"邮箱无效！"},url:{validator:function(_38c){
...
},message:"地址无效！"},length:{validator:function(_38d,_38e){
var len=$.trim(_38d).length;
return len>=_38e[0]&&len<=_38e[1];
},message:"最大允许长度为 {0} - {1}！"},remote:{validator:function(_38f,_390){
var data={};
data[_390[1]]=_38f;
...
var _534=$("<input type=\"text\" class=\"datagrid-editable-input\" maxlength=\"50\">").appendTo(_532);
return _534;
...
var _54b=$("<input type=\"text\" class=\"datagrid-editable-input\" maxlength=\"12\">").appendTo(_549);
_54b.numberbox(_54a);
return _54b;
...
var _554=$("<input type=\"text\" class=\"datagrid-editable-input\" maxlength=\"50\">").appendTo(_552);
...
_784=_784||{};
return this.each(function(){
var _798=$.data(this,"combogrid");
if(_798){
$.extend(_798.options,_784);
}else{
_798=$.data(this,"combogrid",{options:$.extend({},$.fn.combogrid.defaults,$.fn.combogrid.parseOptions(this),_784)});
}
_76d(this);
});
};
...
$("<a href=\"javascript:void(0)\" class=\"datebox-clear\"></a>").html(opts.clear).appendTo(_791);
...
_791.find(".datebox-clear").click(function(){
_78d.calendar.calendar({year:new Date().getFullYear(),month:new Date().getMonth()+1,current:''});
$(_78c).combo("clear");
$(_78c).combo("hidePanel");
...
_792(this,q);
}},currentText:"今天",clear:"清空",closeText:"关闭",okText:"确定",formatter:function(date){
...
$.extend($.fn.combo.methods, {
	hideIcon: function(jq,param){
		return jq.each(function(){
			$.data($(this)[0], 'combo').combo.find('.combo-arrow').hide();
		});
	},
	showIcon: function(jq,param){
		return jq.each(function(){
			$.data($(this)[0], 'combo').combo.find('.combo-arrow').show();
		});
	}
});
