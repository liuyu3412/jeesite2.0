			...
			var tradeseqId = "";
		 	$.ajax({
				...
				success : function(data) {
					...
					// 	+top.ctx+"/wantToReport?reportlet=com.fanRuan.jyzx.report.ReadFromDatabase&cptname=sdgsbindinguser2020.cpt&op=write&planDate="+date+"&partyCode="+participantId+"&sign="+data.sign;
                    url=window.location.href.substring(0, (window.location.href.indexOf('/', window.location.href.indexOf('/') + 3)))
                        +"/ReportServer?reportlet=com.thinkgem.jeesite.modules.report.ReadFromDatabase&cptname=monthyhxxbg20200325.cpt&op=write&planDate="+date+"&partyCode="+participantId+"&sign="+data.sign;
